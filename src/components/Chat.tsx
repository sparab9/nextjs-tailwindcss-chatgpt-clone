  ...
  return (
    <div className="flex max-w-full flex-1 flex-col">
      ...
      <div className="relative h-full w-full transition-width flex flex-col overflow-hidden items-stretch flex-1">
        ...
        <div className="absolute bottom-0 left-0 w-full border-t md:border-t-0 dark:border-white/20 md:border-transparent md:dark:border-transparent md:bg-vert-light-gradient bg-white dark:bg-gray-800 md:!bg-transparent dark:md:bg-vert-dark-gradient pt-2" data-tooltip-id="textbox" data-tooltip-html="Sample Questions: <br /> Where did Shreyas go to college? <br /> Where has Shreyas worked in the past 4 years?" data-tooltip-delay-show={700}>
