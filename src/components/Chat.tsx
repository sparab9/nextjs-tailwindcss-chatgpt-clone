  ...
  return (
    <div className="flex max-w-full flex-1 flex-col">
      ...
      <div className="relative h-full w-full transition-width flex flex-col overflow-hidden items-stretch flex-1">
        ...
        <div className="absolute bottom-0 left-0 w-full border-t md:border-t-0 border-white/20 md:border-transparent md:border-transparent md:bg-vert-light-gradient bg-gray-800 md:!bg-transparent md:bg-vert-dark-gradient pt-2" data-tooltip-id="textbox" data-tooltip-html="Sample Questions: <br /> Where did Shreyas go to college? <br /> Where has Shreyas worked in the past 4 years?" data-tooltip-delay-show={700}>
          <form className="stretch mx-2 flex flex-row gap-3 last:mb-2 md:mx-4 md:last:mb-6 lg:mx-auto lg:max-w-2xl xl:max-w-3xl">
            <div className="relative flex flex-col h-full flex-1 items-stretch md:flex-col">
              ...
              <div className="flex flex-col w-full py-2 flex-grow md:py-3 md:pl-4 relative border  bg-white border-gray-900/50 text-white bg-gray-700 rounded-md shadow-[0_0_15px_rgba(0,0,0,0.10)]">
                <textarea
                  ref={textAreaRef}
                  value={message}
                  tabIndex={0}
                  ...
                  // rows={1}
                  placeholder="Ask me something about Shreyas :)"
